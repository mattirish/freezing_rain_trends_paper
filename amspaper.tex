...
\hline
 &
   ...
   &
  \multicolumn{1}{l}{} &
  \multicolumn{2}{c}{\begin{tabular}[c]{@{}c@{}}Decadal Trend in Frequency \\ (hrs/yr/decade)\end{tabular}} &
  \multicolumn{2}{c}{\begin{tabular}[c]{@{}c@{}}Decadal Trend in Duration \\ (hrs/event/decade)\end{tabular}} &
  \multicolumn{2}{c}{\begin{tabular}[c]{@{}c@{}}Decadal Trend in Intensity \\ (\% of reports light precip./decade)\end{tabular}} \\ \cline{5-10} 
State or Province &
  City &
  ICAO ID &
  Median hrs/yr &
  ...
  1976--2014 &
  1996--2014 \\ \hline
\multirow{7}{*}{IA}  & Burlington                 & KBRL & 10   & 2     & 4.9   & -0.2* & 0    & -1.8\%* & -1.8\%   \\
...
\multirow{9}{*}{PA}  & Allentown                  & KABE & 20   & -1.4  & 3.1   & 0*    & 0    & -6.4\%* & -11.2\%  \\
                     ...
                     & Williamsport               & KIPT & 10   & -2.4  & -0.3  & 0     & 0    & 0\%*    & 0\%      \\ \cline{2-10} 
                     &                            &      & 17   & 0.7   & -2.8  & 0     & 0.6* & 0\%*    & 0\%      \\ \hline
\multirow{3}{*}{QC}  & Ottawa                     & CYDH & 32   & -2.8  & 0.3*  & 0     & 0    & 0\%*    & 0\%      \\
                     & Rouyn-Noranda              & CYUY & 12   & 3*    & -0.6  & -0.1* & 0    & 0\%     & 0\%      \\
                     & Val-d'Or                   & CYVO & 13   & 1.8   & 0*    & 0*    & 0*   & 0\%     & 0\%      \\ \cline{2-10} 
                     &                            &      & 6    & -0.3  & 0*    & 0*    & 0*   & 0\%     & 0\%      \\ \hline
\multirow{6}{*}{WI}  & Eau Claire                 & KEAU & 6    & -0.4  & 0*    & 0*    & 0*   & 0\%*    & 0\%      \\
                     & Green Bay                  & KGRB & 7    & 0     & 0*    & 0*    & 0*   & 0\%     & 0\%      \\
                     & La Crosse                  & KLSE & 5    & 0     & 0*    & 0*    & 0*   & 0\%     & 0\%      \\
                     & Madison                    & KMSN & 8    & 0     & 0*    & 0*    & 0*   & 0\%     & 0\%      \\
                     & Milwaukee                  & KMKE & 6    & -1.3* & 0*    & 0*    & 0*   & 0\%*    & 0\%      \\
                     & Wausau                     & KAUW & 10   & 1.5   & 0*    & 0*    & 0*   & 0\%     & 0\%      \\ \cline{2-10} 
                     &                            &      & 10.5 & 0.2   & 0*    & 0*    & 0*   & 0\%*    & 0\%      \\ \hline
\begin{tabular}[c]{@{}c@{}}Domain \\ Average\end{tabular} &
   &
   &
  9 &
  -0.6 &

...
\toprule
 &
  ...
  \multicolumn{2}{c}{\begin{tabular}[c]{@{}c@{}}Decadal Trend in Intensity \\ (\% of reports light precip./decade)\end{tabular}} \\ \midrule
State or Province &
  City &
  ICAO ID &
  Median hrs/yr &
...
\multirow{6}{*}{WI}  & Eau Claire                 & KEAU & 6    & -0.4  & 0*    & 0*    & 0*   & 0\%*    & 0\%      \\
                     ...
                     & Wausau                     & KAUW & 10   & 1.5   & 0*    & 0*    & 0*   & 0\%     & 0\%      \\ \cmidrule(l){2-10} 
                     &                            &      & 10.5 & 0.2   & 0*    & 0*    & 0*   & 0\%*    & 0\%      \\ \midrule

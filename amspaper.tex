...
[RBR2]These should be changed to current affiliations, and then in foot note, and work done while at … (so I should be at NREL in the title? Doesn't that imply the work is approved by NREL? I'm pretty sure that would warrant me telling my group and NREL's internal review process taking place.)
...
[RBR5]This needs a reference as do several other items in the intro.
[RBR6]Do not hold paper up for this.
[RBR7]Don’t let this hold us up.
[RBR8]I think this is where BJ wanted to add some content.
...
[RBR12]What does positively skewed mean here?
...
[RBR22]Definitely need reference.
